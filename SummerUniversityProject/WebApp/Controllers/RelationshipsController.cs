...
namespace WebApp.Controllers
{
    public class RelationshipsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Relation,Id")] Relationship relationship)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Relation,Id")] Relationship relationship)
        {
